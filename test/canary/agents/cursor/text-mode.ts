/**
 * E2E-8 against the Cursor Agent CLI: a handoff opened with no overlay listening comes back as
 * text mode (T-069, TECHNICAL-DESIGN §11.5, §5.9, SRV-14..16).
 *
...
import type { CursorCliScenario } from './scenario.ts';
...
export const cursorTextModeScenario: CursorCliScenario = {
  id: 'cursor-e2e-08-text-mode',
  title: 'a handoff the Cursor CLI opens with no overlay listening comes back as text mode',
  covers: ['E2E-8'],
  surface: 'cli',
